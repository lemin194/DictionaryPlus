...
def translate_image(img):
	...
	for cnt in contours:
		...
		shrink = 6
		if (min(w, h) < 2 * shrink): shink = 0
		white_out = ret_img[y+shrink:y+h-shrink, x+shrink:x+w-shrink]
		white_out[:] = [240, 240, 240]
		ret_img = draw_text_lines(ret_img, (x, y, w, h), lines, fontpath, (16, 16, 16))
